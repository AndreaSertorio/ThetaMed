      ...
      <div className="flex flex-col space-y-20 w-full mx-40">
        ...
        <div className="flex flex-col md:flex-row space-y-6 md:space-y-10 md:space-x-2 w-full">
          <div className="flex flex-col justify-center space-y-4 space-x-10 w-full md:w-1/2 md:order-last">
            ...
            <p className="text-lg mb-4">ECOTREDI Multisonda è una star up innovatica che vuole entrare nel campo biomedico, con un focus sull&apos;innovazione delle tecniche ecografiche e l&apos;intelligenza artificiale (AI). La nostra missione è rivoluzionare le metodiche di imaging attraverso l&apos;ecografia, offrendo soluzioni più precise, efficienti e personalizzate per la diagnosi.</p>
